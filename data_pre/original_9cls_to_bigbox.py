...
def generate_labels(fp, save_path):
...
save_path_train = './data/aicity2024_track5/stage1/labels/train'
generate_labels(fp, save_path_train)

fp = './data/aicity2024_track5/stage1/annoations/original_val'
save_path_val = './data/aicity2024_track5/stage1/labels/val'
generate_labels(fp, save_path_val)
