...
def generate(fp, path):
  ...
  for eachline in fp.readlines():  # 读取每一行数据
      ...
      filename = path + f"{new_name}.txt"
      with open(filename,'a') as output_file:
          output_file.write(new_line)

fp = open("./data/aicity2024_track5/stage1/train.txt",'r')
path = f"./data/aicity2024_track5/stage1/annoations/original_train/"
generate(fp, path)
path = f"./data/aicity2024_track5/stage1/annoations/original_val/"
fp = open("./data/aicity2024_track5/stage1/val.txt",'r')
generate(fp, path)
