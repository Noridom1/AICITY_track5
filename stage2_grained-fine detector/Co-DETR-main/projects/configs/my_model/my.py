...
data_root = '/data1/zhp/2024AICITY/stage2_datasets_v3.0/one-person/images/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        type='CocoDataset',
        ann_file='./data/aicity2024_track5/stage2/test_ann.json',
        img_prefix= './data/aicity2024_track5/stage2/images/test/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
